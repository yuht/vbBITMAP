...
//{5} = 评论IP
//{6} = 评论内容
var bodyFeedbackDiv = "<dl class=\"question\"><dt><a id=\"{2}\" style=\"display: none\" title=\"permalink: {0}\" href=\"{1}#{2}\"></a><a href=\"http://hi.csdn.net/{3}\" target=\"_blank\" rel=\"nofollow\">{3}</a>&nbsp;发表于{4}&nbsp;&nbsp;<span style='display:none;'>IP:{5}</span><a href=\"mailto:yuexn@csdn.net?subject=垃圾评论举报&body=用户ID:{3} 评论内容:{6} 文章链接:{1} 发表时间:{4}\">举报</a></dt><dd>{6}</dd></dl>";
