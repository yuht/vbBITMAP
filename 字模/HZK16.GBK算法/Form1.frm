...
Private Sub MnuTray12864_Click() '12864控制
    ...
    Me.MnuTray12864.Visible = Frame3(3).Visible
    Adjust
End Sub

Private Sub mnuTray240128_Click() '240128控制
    Frame3(2).Visible = Not Frame3(2).Visible
    Me.mnuTray240128.Visible = Frame3(2).Visible
    Adjust
End Sub

Private Sub mnuTrayAbout_Click() '关于
    MsgBox Me.Caption & vbCrLf & vbCrLf & "     版本:2.0", vbInformation
End Sub
...
Private Sub Form_Load()
    ...
    Frame3(0) = "字体预览"
    Frame3(1) = "汉字内码列表"
    Frame3(2) = "240*128    JD240128-7  吉林宏源科学仪器有限公司液晶专用"
    Frame3(3) = "128* 64    JD12864C-1  吉林宏源科学仪器有限公司液晶专用"
